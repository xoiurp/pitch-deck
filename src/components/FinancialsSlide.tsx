...
const MetricRow = ({ metric, y2025, y2026, y2027 }: MetricRowProps) => (
  ...
  >
    ...
    <div className="text-[16px] font-sofia font-light font-medium text-gray-700">{metric}</div>
    <div className="text-center text-[16px] font-sofia font-light text-primary font-semibold">{y2025}</div>
    <div className="text-center text-[16px] font-sofia font-light text-primary font-semibold">{y2026}</div>
    <div className="text-center text-[16px] font-sofia font-light text-primary font-semibold">{y2027}</div>
  </motion.div>
);
      ...
      >
        ...
        >
          <div className="grid grid-cols-4 gap-4 py-3 border-b-2 border-gray-300 mb-4">
            {/* Estilo menor/detalhe aplicado (mantendo cor/peso) */}
            <div className="text-[16px] font-sofia font-light font-bold text-gray-800">Métrica</div>
            <div className="text-center text-[16px] font-sofia font-light font-bold text-gray-800">2025 (Lanç. Jul)</div>
            <div className="text-center text-[16px] font-sofia font-light font-bold text-gray-800">2026</div>
            <div className="text-center text-[16px] font-sofia font-light font-bold text-gray-800">2027</div>
          </div>
        ...
        {/* Estilo menor/detalhe aplicado */}
        <motion.div
          className="text-center text-[16px] text-[#1A1918] font-sofia font-light italic"
          variants={itemAnimation}
        >
