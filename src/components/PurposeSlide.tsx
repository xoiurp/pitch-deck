  ...
  return (
    <Slide className="bg-gradient-to-b from-[#FFFFF] via-[#F1DFCD]  to-white">
      ...
      >
        ...
        <motion.h2
          className="text-[64px] font-semibold text-primary mb-4" // Padrão SolutionSlide aplicado (font-semibold)
        ...
        <motion.p
          className="text-xl text-[#8A3A34] max-w-2xl mx-auto mb-8 font-sofia font-bold"
          variants={itemAnimation}
        >
        ...
        <motion.p
          className="text-[20px] text-[#1A1918] max-w-2xl mx-auto font-sofia font-light"
          variants={itemAnimation}
        >
