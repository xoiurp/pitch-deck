    ...
    <Slide className="bg-gray-50">
      ...
      >
        <motion.h2 // Removida a duplicação
          // Tamanho de fonte responsivo
          className="pt-18 text-xl md:text-5xl lg:text-[48px] font-semibold text-primary mb-4 text-center" // Adicionado text-center, ajustado tamanho mobile, adicionado padding top mobile
          variants={itemAnimation}
        >
