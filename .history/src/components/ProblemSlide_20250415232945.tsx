    ...
    <Slide className="bg-gray-50">
      ...
      >
        <motion.h2 // Removida a duplicação
          // Tamanho de fonte responsivo
          className="text-2xl md:text-5xl lg:text-[48px] font-semibold text-primary mb-2 text-center" // Adicionado text-center
          variants={itemAnimation}
        >
          ...
          >
            {/* Tamanho e max-width responsivos */}
            <p className="text-base md:text-lg lg:text-[16] text-[#1A1918] mx-auto font-sofia font-light mb-4 md:max-w-2xl">
