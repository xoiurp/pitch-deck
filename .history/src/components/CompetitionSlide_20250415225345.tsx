        ...
        <motion.div className="bg-white rounded-xl shadow-lg p-8" variants={containerAnimation}>
          ...
          <div className="mb-6">
            <div className="grid grid-cols-4 gap-4 py-3 border-b-2 border-gray-300 bg-gray-100 rounded-t-lg">
              {/* Estilo menor/detalhe aplicado como base, mantendo peso/cor */}
              <div className="text-[16px] font-sofia font-bold text-gray-800">Feature</div>
              <div className="text-[16px] font-sofia font-bold text-primary">[e] eles</div>
              <div className="text-[16px] font-sofia font-bold text-gray-800">Manual / Omens</div>
              <div className="text-[16px] font-sofia font-bold text-gray-800">Hims & Hers (Global)</div>
            </div>
