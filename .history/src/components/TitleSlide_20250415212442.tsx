  ...
  return (
    <Slide className="bg-gradient-to-b from-[#F0DCC9] via-[#F1DFCD] to-white">
      <div className="flex flex-col items-center justify-center h-full text-center">
        <motion.h1
          className="text-6xl font-bold text-primary mb-6 font-sofia text-[#8A3A34]"
        ...
        <motion.p
          className="text-xl text-[#8A3A34] max-w-2xl mb-8 font-sofia font-light"
          variants={textAnimation}
          custom={1}
        >
        ...
        <motion.div
          className="text-primary font-sofia font-light text-[#8A3A34]"
          variants={textAnimation}
          custom={2}
        >
