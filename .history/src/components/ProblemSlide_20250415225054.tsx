    ...
    <Slide className="bg-gray-50">
      ...
      >
        <motion.h2 // Removida a duplicação
          className="text-[48px] font-semibold text-primary mb-4" // Estilo do título aplicado
          variants={itemAnimation}
        >
          ...
          >
            ...
            <p className="text-xl text-[#8A3A34] max-w-2xl mb-8 font-sofia font-semi-bold">
              Homens (20-40 anos) adiam ou evitam cuidados médicos.
            </p>
            {/* Padrão SolutionSlide Texto Principal aplicado */}
            <p className="text-[20px] text-[#1A1918]  mx-auto font-sofia font-light">
          ...
          >
            {/* Padrão SolutionSlide Texto Principal aplicado */}
            <p className="text-[20px] text-[#1A1918]  mx-auto font-sofia font-light mb-6">
