  ...
  return (
    <div className="relative w-full h-screen overflow-hidden">
      ...
      <div className="absolute top-1/2 transform -translate-y-1/2 w-full flex justify-between px-4 pointer-events-none">
        {/* Contador de slides (centralizado na parte inferior) */}
        ...
        <button
          ...
          className="w-12 h-12 flex items-center justify-center rounded-full bg-gradient-to-r from-white to-[#8E4A32] text-[#8E4A32] shadow-lg backdrop-blur-sm bg-opacity-80 hover:bg-opacity-100 transition-all pointer-events-auto"
        ...
        <button
          onClick={nextSlide}
          className="w-12 h-12 flex items-center justify-center rounded-full bg-gradient-to-l from-white to-[#8E4A32] text-[#8E4A32] shadow-lg backdrop-blur-sm bg-opacity-80 hover:bg-opacity-100 transition-all pointer-events-auto"
